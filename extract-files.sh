...
adb pull /system/bin/record ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull /system/bin/recordvideo ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
adb pull /system/lib/libOpenSLES.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
